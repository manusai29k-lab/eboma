      ...
      <header className="relative z-10 border-b border-white/5">
        <div className="container flex h-16 items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-lg font-bold text-white">طلباتي السابقة</h1>
          </div>
        </div>
      </header>
          ...
          <TabsContent value="physical">
            {physicalOrders.isLoading ? (
                  ...
                  <div key={order.id} className="rounded-2xl bg-white/[0.03] border border-white/10 p-5 backdrop-blur-sm hover:bg-white/[0.05] transition-colors">
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <div className="text-start shrink-0">
                        <p className="text-lg font-bold text-violet-300">{order.totalPrice.toLocaleString()} د.ع</p>
              ...
              <div className="text-center py-12">
                ...
                <p className="text-white/40">لا توجد طلبات مادية بعد</p>
              </div>
            )}
          </TabsContent>
          ...
          <TabsContent value="digital">
            {digitalSales.isLoading ? (
                  ...
                  <div key={sale.id} className="rounded-2xl bg-white/[0.03] border border-white/10 p-5 backdrop-blur-sm hover:bg-white/[0.05] transition-colors">
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex-1 space-y-1">
                        ...
                        <p className="text-sm text-white/60"><span className="text-white/40">رقم الزبون:</span> <span dir="ltr">{sale.customerPhone}</span></p>
                        <p className="text-sm text-white/60"><span className="text-white/40">المنتج:</span> {sale.productType}</p>
                        {sale.proofImageUrl && (
                      ...
                      <div className="text-start shrink-0">
                        <p className="text-lg font-bold text-emerald-300">{sale.productPrice.toLocaleString()} د.ع</p>
              ...
              <div className="text-center py-12">
                ...
                <p className="text-white/40">لا توجد مبيعات رقمية بعد</p>
              </div>
            )}
          </TabsContent>
        </Tabs>
