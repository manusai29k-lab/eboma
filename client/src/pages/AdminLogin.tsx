        ...
        <div className="container flex h-16 items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] text-white/40 mt-0.5">لوحة الإدارة</p>
            </div>
          </div>
        </div>
      </header>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="relative bg-[#0d1020]/80 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl">
            ...
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl font-bold text-white">دخول المدير</h2>
              <p className="text-sm text-white/50 mt-2">سجّل دخولك للوصول إلى لوحة إدارة EBOMA</p>
            </div>

            {/* Login Form */}
            <form onSubmit={handleLogin} className="space-y-5">
              <div className="space-y-2">
                <Label htmlFor="admin-login-username" className="text-white/70 text-sm">اسم المستخدم</Label>
                <Input
              ...
              <div className="space-y-2">
                <Label htmlFor="admin-login-passcode" className="text-white/70 text-sm">كلمة السر</Label>
                <Input
              ...
              >
                {isLoginLoading ? (
                  ...
                  <><ShieldCheck className="w-4 h-4 ms-2" /> دخول</>
                )}
              </Button>
            </form>
          </div>
